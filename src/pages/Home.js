...
const Home =(props)=>{
    ...
    const getWeather = async()=>{
        ...
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=${myCity}&APPID=4cdca6a93bdabb55c29a57264ce4dccc&units=metric`)
            .then(res=>res.json())
            .then(result=>{
                setInfo({
                    name:result.name,
    ...
    return(
        ...
        <Header name="Home Screeen"/>
            <View style={{alignItems:'center'}}>
                ...
                <Image source={{uri:"https://openweathermap.org/img/w/"+info.icon+".png"}} style={{width:120, height:120, borderRadius:60}}/>
            </View>
